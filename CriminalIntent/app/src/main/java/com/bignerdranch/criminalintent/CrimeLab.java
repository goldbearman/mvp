...
import static com.bignerdranch.criminalintent.database.CrimeDbSchema.CrimeTable.Cols.*;
...
public class CrimeLab {
    ...
    public void deleteCrime(Crime crime) {
        ...
        mDatabase.delete(CrimeTable.NAME, UUID + " = ?", new String[]{id});

    }


    public File getPhotoFile(Crime crime) {
        //Получаем внутренний каталог приложения
